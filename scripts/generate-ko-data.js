...
const COMMENT_MAP = {
  ...
  "Agyoの遺志は受け継がれる・・・": "Agyo의 의지는 이어진다...",
  "みつけたらラッキー！？": "찾으면 행운!?",
  "この張り紙、どこかで見たような・・・":
    "이 전단지, 어디선가 본 것 같은데...",
  "遠くから見たらチョコミントAkyoに見えるかも！":
    "멀리서 보면 초코민트 Akyo로 보일지도!",
  "（ささのきの手記）\n水中の環境に適応したakyo。泳ぐのは得意ではないようで、よく打ち上げられている":
    "(사사노키의 수기)\n수중 환경에 적응한 Akyo. 수영은 잘하지 못하는 듯하며 자주 해변으로 떠밀려온다.",
  "（ささのきの手記）\n濃いソースの香りが食欲をそそる。 炭水化物と炭水化物でお腹も大満足":
    "(사사노키의 수기)\n진한 소스 향이 식욕을 자극한다. 탄수화물과 탄수화물의 조합으로 배도 든든하다.",
  "（ささのきの手記）\nプリンakyoのプリン屋さん。うしakyoの新鮮なミルクを使ったプリンはとっても濃厚で、やみつきになるほど美味しい":
    "(사사노키의 수기)\n푸딩 Akyo의 푸딩 가게. 소 Akyo의 신선한 우유로 만든 푸딩은 아주 진하고, 중독될 만큼 맛있다.",
  "（ささのきの手記）\nサメパーカーを着たきつねakyo。部屋着にもお出かけにも。":
    "(사사노키의 수기)\n상어 후드를 입은 여우 Akyo. 실내복으로도 외출복으로도 좋다.",
  "まあそういう時もあるさ！": "뭐, 그럴 때도 있지!",
  "Akyoがすくすくと育ちますように・・・":
    "Akyo가 무럭무럭 자라기를...",
  "メニューからAkyoが出せるよ！": "메뉴에서 Akyo를 꺼낼 수 있어!",
  "【ささのきの手記】\nサメパーカを着たサメakyo。陸上の生活に慣れてきたのかも？":
    "(사사노키의 수기)\n상어 후드를 입은 상어 Akyo. 육지 생활에 익숙해진 걸지도?",
  "【ささのきの手記】\n固い甲羅を持ち、波の穏やかな浅海に住む。恐竜の時代よりもずっと昔から存在したとされ、「生きた化石」とも呼ばれる":
    "(사사노키의 수기)\n단단한 등딱지를 가지고 있으며 파도가 잔잔한 얕은 바다에 산다. 공룡 시대보다 훨씬 오래전부터 존재했다고 하며, ‘살아 있는 화석’이라고도 불린다.",
  "おいしそう！": "맛있어 보여!",
  "いろんな表示ギミックのサンプルがあるよ！":
    "여러 가지 표시 기믹 샘플이 있어!",
  "Akyo界最強のAkyoが今ここに誕生する‥‥":
    "Akyo계 최강의 Akyo가 지금 이곳에 탄생한다...",
  "【ささのきの手記】\nラッコakyo。ぷかぷかと海面を漂い、よく貝を食べている":
    "(사사노키의 수기)\n해달 Akyo. 바다 위를 둥둥 떠다니며 조개를 자주 먹는다.",
  "【ささのきの手記】\nとてもかしこいakyo。なんだか怪しい研究をしているようだ":
    "(사사노키의 수기)\n아주 똑똑한 Akyo. 어쩐지 수상한 연구를 하는 듯하다.",
  "かっぱAkyoが喜びそう！": "갓파 Akyo가 좋아할 것 같아!",
  "どういう意味だろう？": "무슨 뜻일까?",
  "【ささのきの手記】\nAkyoは青かった":
    "(사사노키의 수기)\nAkyo는 푸르렀다.",
  "よくわからないけど、すごい力を感じるね！":
    "잘 모르겠지만, 엄청난 힘이 느껴져!",
  "AkyoでできたAkyo！？\nAgyoの対になる存在かもしれないね。":
    "Akyo로 만들어진 Akyo!?\nAgyo와 짝을 이루는 존재일지도 몰라.",
  "ここには映らないみたい・・・\nきみの目で確かめてみて！":
    "여기에는 비치지 않는 것 같아...\n네 눈으로 직접 확인해 봐!",
  "街が見えるような気がする・・・\nどこの街だろう？":
    "도시가 보이는 것 같아...\n어느 도시일까?",
  "【ささのきの手記】\n釣りの楽しみを知ったきつねakyo。今日は何が釣れるかな？":
    "(사사노키의 수기)\n낚시의 즐거움을 알게 된 여우 Akyo. 오늘은 무엇이 잡힐까?",
  "UV展開したらこんな感じになるみたい！":
    "UV를 펼치면 이런 모습이 되는 것 같아!",
  "Akyoのえかきうたが作れるかも！":
    "Akyo 그림 노래를 만들 수 있을지도!",
  "えっ！？うしろにブラックホール！？": "뭐!? 뒤에 블랙홀이!?",
  "何の変哲もないAkyoに見えるけど・・・？":
    "평범한 Akyo처럼 보이는데...?",
  "【ささのきの手記】\n暖かい海域に生息するakyo。緩やかな海流が好みのようで、よく熱帯魚と遊んでいる":
    "(사사노키의 수기)\n따뜻한 해역에 사는 Akyo. 완만한 해류를 좋아하는 듯하며 열대어와 자주 놀고 있다.",
  "えっ？どれが本物？？": "어? 어느 게 진짜야??",
  "チョコミントアイスもある！！": "초코민트 아이스크림도 있어!!",
  "向こう側にも、Akyoがいる。": "저편에도 Akyo가 있다.",
  "牛肉が入ってるのかな？": "소고기가 들어 있는 걸까?",
  "【ささのきの手記】\n塗装が剥がれ、全体が錆びついたakyo。「形あるもの、いずれ朽ちる」とはいえ本人は元気そうである":
    "(사사노키의 수기)\n도장이 벗겨져 몸 전체가 녹슨 Akyo. ‘형태 있는 것은 언젠가 썩는다’고 하지만 본인은 여전히 건강해 보인다.",
  "【ささのきの手記】\nSFな世界で生きるakyo。危険な作業もおまかせ！ただ、あくまでakyoであることを忘れないように。":
    "(사사노키의 수기)\nSF 세계에서 사는 Akyo. 위험한 작업도 맡겨 줘! 다만 어디까지나 Akyo라는 사실을 잊지 말자.",
  "【ささのきの手記】\n星のコアから生まれたakyo。太古の熱をその身に宿している":
    "(사사노키의 수기)\n별의 핵에서 태어난 Akyo. 태고의 열을 몸에 품고 있다.",
  "【ささのきの手記】\n大阪名物たこ焼きakyo。焼きたてほやほやアツアツをどうぞ！":
    "(사사노키의 수기)\n오사카 명물 타코야키 Akyo. 갓 구워 뜨끈뜨끈할 때 드세요!",
  "あっ！ムルルのまめAkyoがいる！": "앗! 무루루의 콩 Akyo가 있어!",
  "巫女さんだ～！かわいい～！": "무녀다~! 귀여워~!",
  "絶対にはがさないでね！": "절대로 떼지 마!",
  "【ささのきの手記】\n砂浜で生まれたakyo":
    "(사사노키의 수기)\n모래사장에서 태어난 Akyo.",
  "キツネツキ式狐Akyoがいるよ！": "키츠네츠키식 여우 Akyo가 있어!",
  "Akyo空っぽのほうが～夢詰め込める～♪":
    "Akyo는 속이 비어 있을수록~ 꿈을 더 채울 수 있어~♪",
  "Akyo、きみだったのか。": "Akyo, 너였구나.",
  "歴史上初めてAkyoがこたつを使った瞬間である。":
    "역사상 처음으로 Akyo가 코타츠를 사용한 순간이다.",
  "梅雨が終わったみたい！": "장마가 끝난 것 같아!",
  "ついてくる狐Akyoがいる実験室だよ！":
    "따라오는 여우 Akyo가 있는 실험실이야!",
  "カラフル回転Akyoがいる～！": "컬러풀 회전 Akyo가 있어~!",
  // --- IDs 0879-0940 (added 2026-09) ---
  'Akyoたちがいっぱいいる！\n入ると手を振ってくれるよ！': 'Akyo들이 잔뜩 있어!\n들어가면 손을 흔들어 줘!',
  'Akyoの王、Akyooh': 'Akyo의 왕, Akyooh',
  '願いが成就するとき、もう一つの目が現れる・・・': '소원이 이루어질 때, 또 하나의 눈이 나타난다...',
  'Akyoに願いを！': 'Akyo에게 소원을!',
  'アロ～ハ～！': '알로~하~!',
  'この景色、どこかで・・・': '이 풍경, 어디선가...',
  'からだだけついてくる！？': '몸만 따라온다니!?',
  '付け髭なのかな？': '붙인 수염인 걸까?',
  '【ささのきの手記】\nびっくりしているakyo。叫び声を上げそうだ': '(사사노키의 수기)\n놀라 있는 Akyo. 비명을 지를 것 같다',
  'Akyoを召喚！': 'Akyo를 소환!',
  'なが～～～いAkyo！': '기~~~다란 Akyo!',
  '羽がないけど、気合いで飛ぶのかも！': '날개가 없지만, 기합으로 나는 걸지도!',
  'ジョルセロおじさんって知ってる？': '조르셀로 아저씨를 아세요?',
  'かつては虹色に輝いていたその姿は、厄災の力に呑まれ今では封印されている。\n残された我々には、いつかの未来で再び人々に虹の輝きを与えてくれるはずだと信じることしかできない。': '한때 무지갯빛으로 빛나던 그 모습은 재앙의 힘에 삼켜져 지금은 봉인되어 있다.\n남겨진 우리는 언젠가의 미래에 다시 사람들에게 무지개의 빛을 줄 것이라 믿는 수밖에 없다.',
  'Akyoの中にはAkyo、またその中にはAkyo、またその中にもAkyo・・・': 'Akyo 안에는 Akyo, 또 그 안에는 Akyo, 또 그 안에도 Akyo...',
  '片目らしいけど、どういうことだろう？': '외눈이라는데, 무슨 뜻일까?',
  'きれいな水平線が見える！': '아름다운 수평선이 보여!',
  '同時に倒さないと復活するかも！？': '동시에 쓰러뜨리지 않으면 부활할지도!?',
  'バルクアップAkyoにそっくり！\n最強対最強の超絶バトルが始まりそう！': '벌크업 Akyo와 꼭 닮았어!\n최강 대 최강의 초절정 배틀이 시작될 것 같아!',
  '速すぎて見逃さないように注意！': '너무 빨라서 놓치지 않도록 주의!',
  '近づいては、消える。\n何度繰り返しても、結果は変わらない。': '다가가면, 사라진다.\n몇 번을 반복해도 결과는 변하지 않는다.',
  'スポーン地点近くにあるすりガラスのような場所からAkyoのいる部屋に行けます。': '스폰 지점 근처에 있는 젖빛 유리 같은 곳에서 Akyo가 있는 방으로 갈 수 있습니다.',
  '自分好みのAkyoハウスを作っちゃおう！': '자기 취향의 Akyo 하우스를 만들어 보자!',
  '2027年夏のVketで置かれていたレアなAkyoだよ！': '2027년 여름 Vket에 놓여 있던 레어 Akyo야!',
  '【ささのきの手記】\n夏が楽しみでウキウキなだいこんakyoとにんじんakyo': '(사사노키의 수기)\n여름이 기다려져 신이 난 무 Akyo와 당근 Akyo',
  '【ささのきの手記】\nアロハ～な雰囲気のわにakyo。ウクレレを弾くのが趣味のようだ。夕日のビーチが良く似合う': '(사사노키의 수기)\n알로하~한 분위기의 악어 Akyo. 우쿨렐레를 연주하는 것이 취미인 듯하다. 노을 진 해변이 잘 어울린다',
  'ふしぎなAkyo！': '신기한 Akyo!',
  'あきょう玉だ！\nAkyoにAkyo魂をわけてくれ～～～！！！': '아쿄다마다!\nAkyo에게 Akyo 혼을 나눠줘~~~!!!',
  'ラクーンはアライグマのことなんだね！': '라쿤은 일본어로 아라이구마라고 하는구나!',
  'Audiolinkがついてるよ！': 'AudioLink가 달려 있어!',
  'ぐにょんぐにょんしてる！': '말랑말랑 흐물흐물해!',
  '飛ばないAkyoはただのAkyo！？': '날지 않는 Akyo는 그냥 Akyo!?',
  '触ったら硬いのかな？': '만지면 딱딱할까?',
  '【作者コメント】\nFketReal2026Sで作成、販売された「ぷらぷらAkyoストラップ」がバーチャルにもやってきた！ぷらぷらというよりびよんびよん。わっか状の物にフィズボーン入れてきれいに動かしたいと思うと労力がやべえぞ！': '(제작자 코멘트)\nFketReal2026S에서 제작 및 판매된 「흔들흔들 Akyo 스트랩」이 버추얼에도 찾아왔다! 흔들흔들이라기보다 통통 튄다. 고리 모양 물체에 피즈본을 넣어 예쁘게 움직이게 하려면 노력이 어마어마하다!',
  ...
  'ウクレレを携えたAkyoの波がきてる！！': '우쿨렐레를 든 Akyo의 물결이 밀려오고 있어!!',
};
