...
const overridesById = {
  ...
  // --- IDs 0879-0940 (added 2026-09) ---
  // Worlds keep their Japanese names: they are proper names of real VRChat
  // worlds that users search for. 73 of the 77 existing worlds do the same.
  '0879': { Nickname: 'Akyoたちの住む家', Comment: 'There are so many Akyos here!\nThey wave at you when you walk in!' },
  '0880': { Nickname: 'Just 芋掘り - Just imohori -', Comment: '' },
  '0881': { Nickname: 'hospitalCrom', Comment: '' },
  '0882': { Nickname: 'しおさい街道 - Siosai Highway -', Comment: '' },
  '0883': { Nickname: '聖雪オラトリウム -Oratorium in Holy Snow-', Comment: '' },
  '0884': { Nickname: '狐ノ庭', Comment: '' },
  '0885': { Nickname: 'ラスクさんぽ FAN MEETING WORLD', Comment: '' },
  '0886': { Nickname: '夜景と緑のチルルーム -Chill room˸ Night views ＆ Plants-', Comment: '' },
  '0887': { Nickname: 'Just Digging 1․4', Comment: '' },
  '0888': { Nickname: '海に近い部屋', Comment: '' },
  '0889': { Nickname: '町屋旅館 百代通-HAKUTAI-', Comment: '' },
  '0890': { Nickname: 'アバター面接会場', Comment: '' },
  '0891': { Nickname: 'King Akyo', Comment: 'The king of Akyo, Akyooh' },
  '0892': { Nickname: 'Roma\'s Daruma Akyo', Comment: 'When the wish comes true, the other eye appears...' },
  '0893': { Nickname: 'Tanabata Akyo', Comment: 'Make a wish upon Akyo!' },
  '0894': { Nickname: 'Aloha Wolf Akyo', Comment: 'Alo~ha~!' },
  '0895': { Nickname: '21.63 Akyo', Comment: 'This scenery... I have seen it somewhere before...' },
  '0896': { Nickname: 'Look Akyo???', Comment: 'Only the body follows you!?' },
  '0897': { Nickname: 'Suspenders Fox Akyo', Comment: 'Is that a fake mustache?' },
  '0898': { Nickname: 'Surprised Akyo', Comment: '(Sasanoki\'s notes)\nA startled Akyo. It looks about to let out a scream.' },
  '0899': { Nickname: 'Duel Akyo', Comment: 'I summon Akyo!' },
  '0900': { Nickname: 'Akyo-san', Comment: 'A looooong Akyo!' },
  '0901': { Nickname: 'Swallowtail Akyo', Comment: 'It has no wings, but maybe it flies on sheer willpower!' },
  '0902': { Nickname: 'Stylish Akyo', Comment: 'Do you know Uncle Jorcelo?' },
  '0903': { Nickname: 'Rainbow Akyo', Comment: 'Its form, which once shone in rainbow colors, was swallowed by the power of calamity and is now sealed away.\nAll we who remain can do is believe that someday, in some future, it will once again grant people the radiance of the rainbow.' },
  '0904': { Nickname: 'Matryoshka Akyo', Comment: 'Inside an Akyo is an Akyo, and inside that one is an Akyo, and inside that one too is an Akyo...' },
  '0905': { Nickname: 'Akyoについて本気出して考えてみた⁄アキョノグラフィティ', Comment: '' },
  '0906': { Nickname: 'Akyoと一緒の夏-Akyo Summer-', Comment: '' },
  '0907': { Nickname: 'One-Eyed Akyo', Comment: 'They say it has one eye, but what does that mean?' },
  '0908': { Nickname: 'Horizon Akyo', Comment: 'You can see a beautiful horizon!' },
  '0909': { Nickname: 'Twin Akyo', Comment: 'If you do not defeat them at the same time, they might come back!?' },
  '0910': { Nickname: 'Pectoral Akyo', Comment: 'It looks just like Bulked-Up Akyo!\nAn ultimate battle of strongest versus strongest is about to begin!' },
  '0911': { Nickname: 'JUST Bridge', Comment: 'It is so fast, be careful not to miss it!' },
  '0912': { Nickname: 'Akyoの消えた海 - The Sea Where Akyo Vanished', Comment: 'You approach, and it vanishes.\nNo matter how many times you try, the result never changes.' },
  '0913': { Nickname: '羊Akyoを数えて眠りましょ', Comment: '' },
  '0914': { Nickname: '海に沈む花火~Fireworks Over the Sea ~', Comment: 'You can reach the room where the Akyo is from the frosted-glass-like spot near the spawn point.' },
  '0915': { Nickname: 'Create Your World ～部屋作りの出来るワールド～', Comment: 'Build an Akyo house just the way you like it!' },
  '0916': { Nickname: 'Akyo旅館', Comment: '' },
  '0917': { Nickname: 'Gaming Akyo', Comment: 'A rare Akyo that was on display at Vket Summer 2027!' },
  '0918': { Nickname: 'いっけなーい！ 遅刻、遅刻！', Comment: '' },
  '0919': { Nickname: 'Peanut Mameakyo', Comment: '' },
  '0920': { Nickname: 'Aloha Japanese Radish Akyo / Aloha Carrot Akyo', Comment: '(Sasanoki\'s notes)\nA Japanese Radish Akyo and a Carrot Akyo, giddy with excitement for summer.' },
  '0921': { Nickname: 'Aloha Crocodile Akyo', Comment: '(Sasanoki\'s notes)\nA crocodile Akyo with an aloha vibe. Playing the ukulele seems to be its hobby. A sunset beach suits it perfectly.' },
  '0922': { Nickname: 'Souka Akyo', Comment: 'A mysterious Akyo!' },
  '0923': { Nickname: 'Akyo Ball Akyo / But That\'s Akyo', Comment: 'It\'s an Akyo Ball!\nShare your Akyo spirit with Akyo~~~!!!' },
  '0924': { Nickname: 'Raccoon Akyo', Comment: 'So the English word for araiguma is "raccoon"!' },
  '0925': { Nickname: 'Akyo at night', Comment: 'It has AudioLink!' },
  '0926': { Nickname: 'Water Jelly Akyo', Comment: 'It is all wobbly and squishy!' },
  '0927': { Nickname: 'VRCガチャポン専門店', Comment: '' },
  '0928': { Nickname: 'gagonal space', Comment: '' },
  '0929': { Nickname: 'Akyoつりぼり', Comment: '' },
  '0930': { Nickname: 'Crystal Nest', Comment: '' },
  '0931': { Nickname: 'AKYO CATHEDRAL 忘れられた旧神殿', Comment: '' },
  '0932': { Nickname: 'Sauna', Comment: '' },
  '0933': { Nickname: 'ムチォ Hub', Comment: '' },
  '0934': { Nickname: 'Pilot Akyo', Comment: 'An Akyo that does not fly is just an Akyo!?' },
  '0935': { Nickname: 'Block-Type Kitsunetsuki\'s Fox Akyo', Comment: 'I wonder if it feels hard to the touch?' },
  '0936': { Nickname: '安心安全ハウス -Safe and Secure House-', Comment: '' },
  '0937': { Nickname: 'Dangling Akyo Strap Akyo', Comment: '(Creator\'s comment)\nThe "Dangling Akyo Strap" that was made and sold at FketReal2026S has come to the virtual world too! Less dangling, more boing-boing. Getting PhysBones into a ring-shaped object and making it move nicely takes an insane amount of work!' },
