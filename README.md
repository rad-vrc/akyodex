...
- **Data refresh confirmed on `main`**: `origin/main` includes Akyo additions `#0862` through `#0870` plus JSON sync commits up to `2026-06-11T09:50:19Z`.

### 1. Avatar Gallery

- **Catalog scope**: 2026-06-11 時点で `870` 件（`796` avatars / `74` worlds、うち `185` 件が `boothUrl` を保持）
...
- ✅ June 2026 content refresh through `#0870` + JSON sync pipeline
